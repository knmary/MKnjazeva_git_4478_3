...
Удаленныые репозитории используются для совместной работы над проектом (корректировкой файлов), при условии наличия доступа к этому удаленному репозиторию.
