...
### Слияние веток 
Для слияния ветки необходимо сперва переключится на ветку, в кторую будет делаться слияние и после использовать следующую команду с указанием имени вливаемой ветки
